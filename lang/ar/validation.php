...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'يجب أن يكون عدد أحرف الحقل :attribute بين :min و :max حرفًا.',
    ],
    ...
    'digits' => 'يجب أن يكون الحقل :attribute عبارة عن :digits رقمًا.',
    ...
    'max' => [
        ...
        'file' => 'يجب أن لا يتجاوز حجم الحقل :attribute :max كيلوبايت.',
        'numeric' => 'يجب أن لا تكون قيمة الحقل :attribute أكبر من :max.',
        'string' => 'يجب أن لا يحتوي الحقل :attribute على أكثر من :max حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'الحقل :attribute الذي تم تقديمه ظهر في تسريب بيانات. يرجى اختيار :attribute آخر.',
    ],
    ...
    'prohibited_unless' => 'الحقل :attribute ممنوع إلا إذا كان :other هو في :values.',
