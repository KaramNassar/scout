<div x-data="{ open: false, selected: 'en' }" class="relative inline-block">
    ...
    <div x-show="open" x-cloak @click.away="open = false" x-transition
        ...
        <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <button @click="selected = 'fr'; open = false"
                    ...
                    role="menuitem">
                <img src="https://flagcdn.com/sy.svg" alt="Flag" class="h-5 w-5 mr-2"> Arabic
            </button>
            <button @click="selected = 'en'; open = false"
                    class="flex gap-2 items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 w-full"
                    role="menuitem">
                <img src="https://flagcdn.com/us.svg" alt="Flag" class="h-5 w-5 mr-2"> English
            </button>
        </div>
    </div>
</div>
