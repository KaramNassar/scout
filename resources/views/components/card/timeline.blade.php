...
<div class="relative pb-16 pl-8 group space-y-2 sm:pl-32 ">
    ...
    <div
        ...
        <time
            class="-left-4 mb-3 inline-flex h-6 w-[110px] items-center justify-center rounded-full bg-emerald-100 text-xs font-semibold text-emerald-600 translate-y-0.5 sm:absolute sm:mb-0">
            {{ $troop->created_date }}
        </time>
    </div>
