@props(['troop'])
<div class="relative pb-16 pl-8 group space-y-2 w-[350px] sm:w-auto sm:max-w-[600px] sm:pl-32">
    <div
        class="mb-1 text-lg font-medium text-main-light dark:text-main-dark sm:mb-0 sm:text-xl">{{ $troop->name }}</div>
    <div
        ...
        <time
            class="-left-4 mb-3 inline-flex h-6 items-center justify-center rounded-full bg-emerald-100 text-xs font-semibold text-emerald-600 w-[110px] translate-y-0.5 sm:absolute sm:mb-0">
            {{ $troop->created_date }}
        </time>
    </div>
