<footer class="bg-white dark:bg-gray-800 shadow-inner dark:shadow-white/15 mt-32 text-center sm:text-start">
    <x-container>
        <div class="pb-6 pt-16 lg:pt-24">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2 mb-10">
                    ...
                    <div class="lg:mx-auto rtl:lg:mr-0 rtl:lg:ml-auto">
                        <h4 class="text-lg text-gray-900 dark:text-white font-medium mb-7">{{ __('Who we are') }}</h4>
                        <ul class="text-sm text-gray-600 dark:text-gray-400 transition-all duration-500">
                            <li class="mb-6"><a href="javascript:"
                                                class="hover:text-gray-900 dark:hover:text-gray-200">{{ __('Who we are') }}</a>
                            </li>
                            <li class="mb-6"><a href="javascript:"
                                                class="hover:text-gray-900 dark:hover:text-gray-200">{{ __('Who we are') }}</a>
                            </li>
                            <li><a href="javascript:"
                                   class="hover:text-gray-900 dark:hover:text-gray-200">{{ __('Who we are') }}</a></li>
                        </ul>
                    </div>
                    <div class="lg:mx-auto rtl:lg:mr-0 rtl:lg:ml-auto">
                        ...
                        <ul class="text-sm text-gray-600 dark:text-gray-400 transition-all duration-500">
                            <li class="mb-6"><a href="javascript:"
                                                class="hover:text-gray-900 dark:hover:text-gray-200">{{ __('News and Activities') }}</a>
                            </li>
                            <li class="mb-6"><a href="javascript:"
                                                class="hover:text-gray-900 dark:hover:text-gray-200">{{ __('News and Activities') }}</a>
                            </li>
            ...
            <div class="py-7 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span
                    class="text-sm text-gray-500 ">©{{ __(config('app.name')) }} {{ date('Y') }}, {{ __('All rights reserved') }}.</span>
                    <div class="flex mt-4 space-x-4 rtl:space-x-reverse sm:justify-center lg:mt-0">
                        <a href="javascript:"
