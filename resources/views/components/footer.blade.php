        ...
        <div class="pt-16 pb-6 lg:pt-24">
            ...
            <div class="border-t border-gray-200 py-7 dark:border-gray-700">
                ...
                <span
                    ...
                    <div class="mt-4 flex space-x-4 rtl:space-x-reverse sm:justify-center lg:mt-0">
                        <a href="javascript:"
                        ...
                        ">
                            <svg class="text-white w-[1.25rem] h-[1.125rem]" viewBox="0 0 16 16" fill="none"
                        ...
                        <a href="javascript:"
                           class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
                            <svg class="text-white w-[1.25rem] h-[0.875rem]" viewBox="0 0 16 12" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
