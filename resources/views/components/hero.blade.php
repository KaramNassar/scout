...
>
    ...
    />
    <div
        class="absolute inset-0 bg-white/70 sm:bg-transparent sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l dark:bg-gray-900/60 dark:sm:bg-transparent dark:sm:from-gray-900/75 dark:sm:to-gray-900/25"
    ></div>
    ...
    <x-container>
        ...
        >
            <div class="max-w-2xl text-center ltr:sm:text-left rtl:sm:text-right mt-32">
