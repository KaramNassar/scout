    ...
    <div
            ...
            <div class="mt-12">
                ...
                <ul class="mt-3">
                    <li class="flex items-center gap-4">
                        <div
                            class="bg-[#e6e6e6cf] dark:bg-gray-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 1 0-2.636 6.364M16.5 12V8.25" />
                            </svg>

                        </div>
                        <a target="blank" href="https://veilmail.io/e/FkKh7o"
                           class="text-[#007bff] text-sm dark:text-[#007bff]">
        ...
        <form class="ml-auo space-y-4">
            <input type='text' placeholder='Name'
                   class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300"/>
            <input type='email' placeholder='Email'
                   class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300"/>
            <input type='text' placeholder='Subject'
                   class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300"/>
            <textarea placeholder='Message' rows="6"
                      class="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#007bff] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300"></textarea>
            <button type='button'
